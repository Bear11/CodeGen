...
public class VelocityInfoOp {
    ...
    private final static Logger log = Logger.getLogger(VelocityInfoOp.class);

    public static void generatorCode(String templateFile, Map<String, Object> contextMap,
        ...
        // String vPath = VelocityInfoOp.class.getResource("/").getPath();
        log.info("模板文件所在的路径:" + vPath);
